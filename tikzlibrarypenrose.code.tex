...
\NewDocumentCommand \MakePenroseTile { m m m }
{
  ...
  \spath_show:n {Penrose path tile #1}
}

\NewDocumentCommand \UsePenroseTile {m} 
{
}

\MakePenroseTile {dart} {a A B b} {{(1,0)} {(2,2)} {(3,0)} {(2,-1)}}
