...
This library defines a variety of tools for working with tiles, from defining them to positioning them to deforming them.
...
The vertices can be written in cartesian form: \Verb+{<x>,<y>}+, or in polar: \Verb+{<angle>:<length>}+.
...
The edges of the cluster tiles are actually multi-edges for the matching rules.
